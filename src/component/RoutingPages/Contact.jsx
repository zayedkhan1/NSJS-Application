...
const Contact = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <motion.header 
        className="bg-green-700 py-4 md:py-6 text-center shadow-md"
        initial={{ y: -50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.6 }}
      >
        <motion.h1 
          className="text-white text-2xl sm:text-3xl md:text-4xl font-bold tracking-wide"
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <motion.h2 
              className="text-xl sm:text-2xl font-semibold mb-6 text-gray-800 border-b pb-3"
              variants={itemVariants}
            >
              যোগাযোগ ফর্ম
            </motion.h2>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <motion.div 
                className="relative w-full h-64 md:h-72 bg-gray-200 rounded-md overflow-hidden shadow-inner"
              ...
              >
                ...
                {/* Overlay for map details as seen in the screenshot */}
                <motion.div 
                  className="absolute bottom-0 left-0 right-0 bg-white bg-opacity-95 p-3 text-sm md:text-base"
            ...
            >
              ...
              <motion.div 
                ...
                variants={containerVariants}
              >
                <motion.p variants={itemVariants}><span className="font-semibold">ঠিকানা:</span></motion.p>
                <motion.p variants={itemVariants}>নিঃস্বার্থ সমাজকল্যাণ যুব সংগঠন </motion.p>
                <motion.p variants={itemVariants}>৩ রাস্তা মোড়, কাঞ্চন বাজার (ডিশের অফিসের বিপরীতে),</motion.p>
                <motion.p variants={itemVariants}>কাঞ্চন বাজার , রূপগঞ্জ , নারায়ণগঞ্জ</motion.p>

                <motion.p className="pt-3" variants={itemVariants}><span className="font-semibold">মোবাইল:</span></motion.p>
                <motion.p variants={itemVariants}>
                  <motion.a 
                    href="tel:+8801743-402987" 
                ...
                <motion.p className="pt-3" variants={itemVariants}><span className="font-semibold">ইমেইল:</span></motion.p>
                <motion.p variants={itemVariants}>
                  <motion.a 
                    href="mailto:nsjsofficial2020@gmail.com" 
                    className="text-blue-600 hover:underline"
                    whileHover={{ scale: 1.05 }}
                  >
                    nsjsofficial2020@gmail.com
