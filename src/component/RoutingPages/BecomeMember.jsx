    ...
    return (
     ...
     <div className="w-8/12 mx-auto bg-white p-6 rounded-lg shadow-md">
      ...
      <form className="space-y-1">
        ...
        {/* <div>
          <label className="block text-sm font-medium">* পিতার নাম:</label>
          <input type="text" placeholder="মোহাম্মদ আলী" className="w-full border rounded px-3 py-2 mt-1 focus:ring focus:border-blue-400" />
        </div> */}

        {/* <div className="flex items-center space-x-2">
          <input type="checkbox" id="resident" />
          <label htmlFor="resident" className="text-sm">প্রবাসী</label>
        </div> */}
        ...
        {/* <div>
          ...
          <input type="text" placeholder="পেশা সিলেক্ট করুন" className="w-full border rounded px-3 py-2 mt-1 focus:ring focus:border-blue-400" />
        </div> */}
          <div>
          <label className="block text-sm font-medium">* পেশা:</label>
...
{/* 
        <div>
          <label className="block text-sm font-medium">রেফারেন্স:</label>
          <input type="text" placeholder="রাব্বানা তাকাব্বাল মিনা" className="w-full border rounded px-3 py-2 mt-1 focus:ring focus:border-blue-400" />
        </div> */}
        ...
        {/* <div>
          <label className="block text-sm font-medium">* যে মাধ্যমে প্রদান করতে চান:</label>
          <select className="w-full border rounded px-3 py-2 mt-1 focus:ring focus:border-blue-400">
            <option>অনুদানের মাধ্যম বাছাই করুন</option>
          </select>
        </div> */}
